...
<!-- <a href="/">Back to Main Page</a>	nav bar, top of the page -->
    <br>
    ...
    <hr>
    <p>
    Should you have any question, please <a href="https://work-with-nature.com/nl/contact-nl">contact us</a>
    </p>
    <p class="lead">
    <a class="btn btn-primary btn-sm" href="/" role="button">Back to main page</a>
    </p>
    </div>	 
	</body>
</html>